...
def load_pipeline(device="cuda"):
    BASE_CACHE = "/home/sammys15/scratch/PhD_Project/LATINO-PRO_Implementation/model_cache"
...
def latino(pipe, y, physics, prompt="a high quality photo", N=4,
           ...
           target_size_hw=None, device="cuda", verbose=True):
    """
...
plt.tight_layout()
plt.savefig(Path(OUTPUT_DIR) / "comparison_unconditional.png", dpi=150, bbox_inches="tight")
print(f"Saved comparison to {OUTPUT_DIR}/comparison_unconditional.png")
